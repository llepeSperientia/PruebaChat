$(function () {
    ...
    // ID por defecto para el Alineador
    var DEFAULT_POS_ID = 'rec5fkP54vg2PWEmd';
    ...
    var CACHE_KEY_PROJECTS = 'projects_alineador_cache_data';
    var CACHE_KEY_PROJECTS_TIMESTAMP = 'projects_alineador_last_fetch';
    var CACHE_KEY_PROJECTS_POS = 'projects_alineador_pos_cache';
    var CACHE_KEY_PROJECT_MESSAGES = 'project_alineador_messages_cache';
    ...
    // No hay múltiples POS para Alineador, se usa el POS por defecto.
    ...
    function openNewConversation() {
        ...
        // Conversación normal (POS o archivada)
        showLoading().then(function () {
            renderHeader(DEFAULT_CHAT_NAME || 'Sin nombre', DEFAULT_CHAT_SUBTITLE || '', DEFAULT_AVATAR_URL || '');
            renderMessages();
